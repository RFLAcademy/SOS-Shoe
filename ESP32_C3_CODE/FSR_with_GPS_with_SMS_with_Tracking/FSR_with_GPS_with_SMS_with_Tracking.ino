...
// =====================================================
TinyGPSPlus gps;
HardwareSerial gpsSerial(1);  // GPS UART1
#define GPS_RX 16
#define GPS_TX 17
...
//                  SIM800C SETUP
// =====================================================
HardwareSerial sim800(2);  // SIM800 UART2
#define SIM800_RX 26
#define SIM800_TX 27
...
// --- NEW FUNCTION: UPLOAD TO TRACCAR ---
void uploadToCloud(double lat, double lng) {
  ...
  String url = "http://demo.traccar.org:5055/?id=" + deviceID + "&lat=" + String(lat, 6) + "&lon=" + String(lng, 6);
